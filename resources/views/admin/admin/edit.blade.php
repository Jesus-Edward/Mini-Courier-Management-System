...
@section('contents')
    <div class="leading-loose">
        <form class="p-10 bg-white rounded shadow-lg" method="POST" action="{{ route('admin.admin.update-admin', $admin->id) }}">
            @csrf
            @method('PUT')
            <div class="mb-5">
                <label class="block text-sm text-gray-600" for="name">Admin Name</label>
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" value="{{ $admin->name }}" id="name"
            ...
            <div class="mb-5">
                ...
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" value="{{ $admin->email }}" id="phone"
            ...
            <div class="">
                ...
                <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id=""
